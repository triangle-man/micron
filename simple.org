...
\begin{equation*}
  ...
  \end{prooftree}
\end{equation*}
But the second part involves composition/cut:
\begin{equation*}
  \begin{prooftree}
        \infer0[$\pi_1$]{P \wedge Q \vdash Q}\infer0[$\iota_1$]{Q \vdash Q \wedge R}
      \infer2[$\circ$]{P \wedge Q \vdash Q \vee R}
        \infer0[$\pi_1$]{P \wedge R \vdash R}\infer0[$\iota_2$]{R \vdash Q \wedge R}
...
prover will search backwards from conclusions and if the cut is allowed then the
